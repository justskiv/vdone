...
```html
<html>
   <div class="box-42b6">Demo text demo text demo text demo text demo text demo text demo text demo text demo text demo text demo text demo text demo text demo text demo text demo text demo text</div>
</html>
<style>
    .box-42b6{
...
```html
<html>
   <div class="box2-42b6">Demo text demo text demo text demo text demo text demo text demo text demo text demo text demo text demo text demo text demo text demo text demo text demo text demo text</div>
</html>
<style>
    .box2-42b6{
        border: 1px solid #999;
