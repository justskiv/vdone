...
person.interest() // 张三 is drinking

// Real world: There is a person named 张三, who is drinking.
// Object simulation: A person is abstracted into an object person. The object is a container that encapsulates the property name as 张三, and his drinking is encapsulated as the method interest
