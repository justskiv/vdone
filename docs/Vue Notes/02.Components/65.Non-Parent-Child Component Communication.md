...
<p class="codepen" data-height="400" data-theme-id="light" data-default-tab="js,result" data-user="xugaoyi" data-slug-hash="wvaGwEj" style="height: 400px; box-sizing: border-box; display: flex; align-items: center; justify-content: center; border: 2px solid; margin: 1em 0; padding: 1em;" data-pen-title="Non-Parent-Child Component Communication 2 (Bus / event bus / publish-subscribe / observer pattern)">
  <span>See the Pen <a href="https://codepen.io/xugaoyi/pen/wvaGwEj">
  Non-Parent-Child Component Communication 2 (Bus / event bus / publish-subscribe / observer pattern)</a> by xugaoyi (<a href="https://codepen.io/xugaoyi">@xugaoyi</a>)
